<?php
/**
 * The style "hover" of the collection item
 *
 * @package WordPress
...
?>">
	<div class="sc_collection_item_header <?php echo (int)$args['hide_bg_image']==1 ? ' without_image' : ''; ?>"<?php if ((int)$args['hide_bg_image']==0 && !empty($image)) echo ' style="background-image: url('.esc_url($image).');"'; ?>>
		<div class="sc_collection_item_header_inner">
			<?php
			...
			?>
			<h6 class="sc_collection_item_title"><a href="<?php echo esc_url($link); ?>"><?php the_title(); ?></a></h6>
		...
		<a class="sc_collection_item_link" href="<?php echo esc_url($link); ?>"></a>
	</div>
	<?php if (!isset($args['hide_excerpt']) || (int)$args['hide_excerpt']==0) { ?>
		<div class="sc_collection_item_content"<?php if (!empty($image)) echo ' style="background-image: url('.esc_url($image).');"'; ?>>
