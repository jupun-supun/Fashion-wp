...
if (!function_exists('clothing69_trx_addons_get_css')) {
	add_filter('clothing69_filter_get_css', 'clothing69_trx_addons_get_css', 10, 4);
	function clothing69_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
		
		if (isset($css['fonts']) && $fonts) {
			$css['fonts'] .= <<<CSS

.sc_skills_pie.sc_skills_compact_off .sc_skills_item_title,
.sc_dishes_compact .sc_collection_item_title,
...
.sc_collection .sc_collection_item_subtitle,
...
.sc_layouts_row_type_narrow .sc_layouts_menu_mobile_button .sc_layouts_item_icon,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_menu_mobile_button .sc_layouts_item_icon {
	color: {$colors['text_link']};
}
.sc_layouts_row_type_narrow .sc_layouts_menu_mobile_button .sc_layouts_item_link:hover .sc_layouts_item_icon,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_menu_mobile_button .sc_layouts_item_link:hover .sc_layouts_item_icon {
...
.sc_layouts_row_type_narrow .sc_layouts_item .sc_button:hover {
...
/* Blogger */
.sc_blogger_classic .sc_blogger_item .post_meta .post_meta_item:before,
.sc_blogger_classic .sc_blogger_item .post_meta .post_meta_item {
	color: {$colors['text_hover']};
}
.sc_blogger_classic .sc_blogger_item .post_meta .post_meta_item:hover:before,
.sc_blogger_classic .sc_blogger_item .post_meta .post_meta_item:hover {
	color: {$colors['text_link']};
}
...
/* collection */
.sc_collection .sc_collection_item_number {
	color: {$colors['alter_bg_hover']};
}

.sc_collection_default .sc_collection_item {
	color: {$colors['alter_text']};
	background-color: {$colors['alter_bg_color']};
}
.sc_collection_default .sc_collection_item_icon {
	color: {$colors['alter_link']};
	border-color: {$colors['alter_link']};
}
.sc_collection_default .sc_collection_item:hover .sc_collection_item_icon {
...
.sc_collection_list .sc_collection_item {
	color: {$colors['text']};
	background-color: transparent;
}
...
.sc_collection_list .sc_collection_item_icon {
	color: {$colors['text_link']};
	border-color: {$colors['text_link']};
}
.sc_collection_list .sc_collection_item:hover .sc_collection_item_icon {
	color: {$colors['text_hover']};
}
.sc_collection_default .sc_collection_item_featured_left:hover .sc_collection_item_icon,
.sc_collection_default .sc_collection_item_featured_right:hover .sc_collection_item_icon,
.sc_collection_list .sc_collection_item_featured_left:hover .sc_collection_item_icon,
.sc_collection_list .sc_collection_item_featured_right:hover .sc_collection_item_icon {
	color: {$colors['inverse_dark']};
	background-color: {$colors['text_link']};
	border-color: {$colors['text_link']};
}
.sc_collection_default .sc_collection_item_featured_left .sc_collection_item_subtitle,
.sc_collection_default .sc_collection_item_featured_right .sc_collection_item_subtitle {
	color: {$colors['text_link']};
}

.sc_collection_light .sc_collection_item_icon {
	color: {$colors['text_link']};
}
.sc_collection_light .sc_collection_item:hover .sc_collection_item_icon {
	color: {$colors['text_hover']};
}

.sc_collection_callouts .sc_collection_item {
	background-color:{$colors['alter_bg_color']};
}
.sc_collection_callouts .sc_collection_item_marker {
	border-color: {$colors['bg_color']};
	background-color:{$colors['alter_link']};
	color: {$colors['inverse_link']};
}
.sc_collection_callouts .sc_collection_item .sc_collection_item_marker_back {
	border-color: {$colors['bg_color']};
	background-color:{$colors['alter_hover']};
	color: {$colors['inverse_hover']};
}
.sc_collection_callouts .sc_collection_item_marker_bg {
	border-color: {$colors['bg_color']};
	background-color:{$colors['bg_color']};
}

.sc_collection_timeline .sc_collection_item_timeline {
	border-color: {$colors['bd_color']};
}
.sc_collection_timeline .sc_collection_item_marker {
	border-color: {$colors['text_link']};
	background-color:{$colors['text_link']};
	color: {$colors['inverse_link']};
}
.sc_collection_timeline .sc_collection_item:hover .sc_collection_item_marker {
	border-color: {$colors['text_hover']};
	background-color:{$colors['text_hover']};
	color: {$colors['inverse_hover']};
}

.sc_collection_iconed .sc_collection_item {
	color: {$colors['alter_text']};
	background-color: {$colors['alter_bg_color']};
}
.sc_collection_iconed .sc_collection_item_icon:hover,
.sc_collection_iconed .sc_collection_item:hover .sc_collection_item_icon,
.sc_collection_iconed .sc_collection_item_header .sc_collection_item_subtitle a:hover,
.sc_collection_iconed .sc_collection_item:hover .sc_collection_item_header .sc_collection_item_subtitle a {
	color: {$colors['text_link']};
}
.sc_collection_iconed .sc_collection_item_header .sc_collection_item_title a {
	color: {$colors['text_link']};
}
.sc_collection_iconed .sc_collection_item_header .sc_collection_item_title a:hover,
.sc_collection_iconed .sc_collection_item:hover .sc_collection_item_header .sc_collection_item_title a {
	color: #fff;
}
.sc_collection_iconed .sc_collection_item .sc_collection_item_header .sc_collection_item_subtitle a {
	color: #fff;
}
.sc_collection_iconed .sc_collection_item:hover .sc_collection_item_header .sc_collection_item_subtitle a,
.sc_collection_iconed .sc_collection_item .sc_collection_item_header .sc_collection_item_subtitle a:hover {
	color: {$colors['text_link']};
}
.sc_collection_iconed .sc_collection_item_content .sc_collection_item_title a {
	color: {$colors['alter_dark']};
}
.sc_collection_iconed .sc_collection_item_content .sc_collection_item_title a:hover,
.sc_collection_iconed .sc_collection_item:hover .sc_collection_item_content .sc_collection_item_title a {
	color: {$colors['alter_link']};
}
.sc_collection.slider_swiper .swiper-pagination-bullet {
	border-color: {$colors['text_light']};
}

.sc_collection_list .sc_collection_item_featured_left .sc_collection_item_number,
.sc_collection_list .sc_collection_item_featured_right .sc_collection_item_number {
	color: {$colors['text_light']};
}

.sc_collection_hover .sc_collection_item_icon,
.sc_collection_hover .sc_collection_item_title a:hover,
.sc_collection_hover .sc_collection_item_subtitle a:hover {
	color: {$colors['text_link']};
}
.sc_collection_hover [class*="column-"]:nth-child(2n) .sc_collection_item.with_image .sc_collection_item_header.without_image,
.sc_collection_hover .swiper-slide:nth-child(2n) .sc_collection_item.with_image .sc_collection_item_header.without_image {
	background-color:{$colors['alter_bg_hover']};
}
.sc_collection_hover [class*="column-"]:nth-child(2n+1) .sc_collection_item.with_image .sc_collection_item_header.without_image,
.sc_collection_hover .swiper-slide:nth-child(2n+1) .sc_collection_item.with_image .sc_collection_item_header.without_image {
	background-color:{$colors['alter_bg_color']};
}
.sc_collection_hover .sc_collection_item.with_image .sc_collection_item_header.without_image .sc_collection_item_icon,
.sc_collection_hover .sc_collection_item.with_image .sc_collection_item_header.without_image .sc_collection_item_number {
	color: {$colors['alter_light']};
}
.sc_collection_hover .sc_collection_item.with_image .sc_collection_item_header.without_image .sc_collection_item_title a {
	color: {$colors['alter_dark']};
}
.sc_collection_hover .sc_collection_item.with_image:hover .sc_collection_item_header.without_image .sc_collection_item_title a,
.sc_collection_hover .sc_collection_item.with_image .sc_collection_item_header.without_image .sc_collection_item_title a:hover {
	color: {$colors['alter_link']};
}
.sc_collection_hover .sc_collection_item.with_image .sc_collection_item_header.without_image .sc_collection_item_subtitle a {
	color: {$colors['alter_link']};
}
.sc_collection_hover .sc_collection_item.with_image:hover .sc_collection_item_header.without_image .sc_collection_item_subtitle a,
.sc_collection_hover .sc_collection_item.with_image .sc_collection_item_header.without_image .sc_collection_item_subtitle a:hover {
	color: {$colors['alter_dark']};
}
.sc_collection_hover .sc_collection_item.with_image .sc_collection_item_header.without_image .sc_collection_item_text {
	color: {$colors['alter_text']};
}

.sc_collection_chess .sc_collection_item {
	color:{$colors['alter_text']};
	background-color:{$colors['alter_bg_color']};
}
.sc_collection_chess .sc_collection_item_title a {
	color:{$colors['alter_dark']};
}
.sc_collection_chess .sc_collection_item_title a:hover {
	color:{$colors['alter_link']};
}
.sc_collection_chess .sc_collection_item:hover {
	color:{$colors['text_light']};
	background-color:{$colors['text_dark']};
}
.sc_collection_chess .sc_collection_item:hover .sc_collection_item_title a {
	color:{$colors['bg_color']};
}
.sc_collection_chess .sc_collection_item:hover .sc_collection_item_title a:hover {
	color:{$colors['text_link']};
}


.sc_collection_tabs_simple .sc_collection_item_icon {
	color: {$colors['text_link']};
}
.sc_collection_tabs_simple .sc_collection_item:hover .sc_collection_item_icon,
.sc_collection_tabs_simple .sc_collection_item:hover .sc_collection_item_title,
.sc_collection_tabs_simple .sc_collection_item:hover .sc_collection_item_subtitle,
.sc_collection_tabs_simple .sc_collection_tabs_list_item_active .sc_collection_item_icon,
.sc_collection_tabs_simple .sc_collection_tabs_list_item_active .sc_collection_item_title,
.sc_collection_tabs_simple .sc_collection_tabs_list_item_active .sc_collection_item_subtitle {
	color: {$colors['text_hover']};
}

.sc_collection_tabs .sc_collection_item_content {
	color:{$colors['alter_text']};
	background-color:{$colors['alter_bg_color']};
}
.sc_collection_tabs .sc_collection_item_title a {
	color:{$colors['alter_dark']};
}
.sc_collection_tabs .sc_collection_item_title a:hover {
	color:{$colors['alter_link']};
}
.sc_collection_tabs .sc_collection_tabs_list_item .sc_collection_item_icon {
	color: {$colors['alter_link']};
}
.sc_collection_tabs .sc_collection_tabs_list_item .sc_collection_item_number {
	color: {$colors['alter_light']};
}
.sc_collection_tabs .sc_collection_tabs_list_item {
	background-color:{$colors['alter_bg_color']};
}
.sc_collection_tabs .sc_collection_tabs_list_item:nth-child(2n+2) {
	background-color:{$colors['alter_bg_hover']};
}
.sc_collection_tabs .sc_collection_tabs_list_item:hover,
.sc_collection_tabs .sc_collection_tabs_list_item:nth-child(2n+2):hover {
	background-color:{$colors['alter_bd_hover']};
}
.sc_collection_tabs .sc_collection_tabs_list_item .sc_collection_item_title {
	color:{$colors['alter_dark']};
}
.sc_collection_tabs .sc_collection_tabs_list_item:hover .sc_collection_item_title {
	color:{$colors['alter_link']};
}
.sc_collection_tabs .sc_collection_tabs_list_item:hover .sc_collection_item_icon {
	color:{$colors['alter_hover']};
}
.sc_collection_tabs .sc_collection_tabs_list_item:hover .sc_collection_item_number {
	color: {$colors['alter_text']};
}
.sc_collection_tabs .sc_collection_tabs_list_item.sc_collection_tabs_list_item_active {
	background-color:{$colors['alter_dark']} !important;
}
.sc_collection_tabs .sc_collection_tabs_list_item.sc_collection_tabs_list_item_active .sc_collection_item_title {
	color: {$colors['bg_color']};
}
.sc_collection_tabs .sc_collection_tabs_list_item.sc_collection_tabs_list_item_active .sc_collection_item_icon {
	color: {$colors['alter_link']};
}
.sc_collection_tabs .sc_collection_tabs_list_item.sc_collection_tabs_list_item_active .sc_collection_item_number {
	color: {$colors['alter_link']};
}
...
.trx_addons_popup .trx_addons_tabs_content.trx_addons_login_content,
.trx_addons_popup #trx_addons_register_content.trx_addons_tabs_content {
	background-color: {$colors['bg_color']};
}
...
.trx_addons_cv_resume_style_collection .trx_addons_cv_resume_item_icon {
	color: {$colors['alter_dark']};
}
.trx_addons_cv_resume_style_collection .trx_addons_cv_resume_item_icon:hover,
.trx_addons_cv_resume_style_collection .trx_addons_cv_resume_item_text a:hover {
	color: {$colors['text_hover']};
}
.trx_addons_cv_resume_style_collection .trx_addons_cv_resume_item_title > a:hover:after {
	border-color: {$colors['text_hover']};
}
.trx_addons_cv_resume_style_collection .trx_addons_cv_resume_item_title > a:after {
	border-top-color: {$colors['alter_dark']};
}
.trx_addons_cv_resume_style_collection .trx_addons_cv_resume_item_text a {
	color: {$colors['alter_dark']};
}
...
.go_bordered.sc_item_button.sc_button_wrap:before {
	background-color: {$colors['text_hover']};
}
...
.post_meta_single_coll .cat_wrap a,
.post_meta_single_coll .cat_wrap {
	color: {$colors['text_hover']};
}
.post_meta_single_coll .cat_wrap a:hover {
	color: {$colors['text_link']};
}
.col_info_footer:before {
	background-color: {$colors['text_dark']};
}
...
.col_info_footer a.second {
	background-color: {$colors['text_link']};
}
.col_info_footer a:hover {
	background-color: {$colors['text_link']};
	border-color: {$colors['bd_color']};
	color: {$colors['inverse_link']};
}
.col_info_footer a.second:hover {
	background-color: {$colors['text_hover']};
}

.sc_layouts_row_type_compact .search_wrap.search_style_normal.layouts_search .search_field {
	background-color: {$colors['text_hover']} !important;
	color: {$colors['inverse_link']} !important;
}
.sc_layouts_row_type_compact .search_wrap.search_style_normal.layouts_search .search_field::-webkit-input-placeholder {color:{$colors['inverse_link']}; opacity: 1;}
.sc_layouts_row_type_compact .search_wrap.search_style_normal.layouts_search .search_field::-moz-placeholder          {color:{$colors['inverse_link']}; opacity: 1;}
