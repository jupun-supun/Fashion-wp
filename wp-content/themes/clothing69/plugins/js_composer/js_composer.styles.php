...
if ( !function_exists( 'clothing69_vc_get_css' ) ) {
	add_filter( 'clothing69_filter_get_css', 'clothing69_vc_get_css', 10, 4 );
	function clothing69_vc_get_css($css, $colors, $fonts, $scheme='') {
...
.sc_promo .vc_progress_bar.vc_progress_bar_narrow .vc_single_bar {
