...
jQuery(document).on('action.init_hidden_elements', function(e, cont) {
	"use strict";
	if (CLOTHING69_STORAGE['button_hover'] && CLOTHING69_STORAGE['button_hover']!='default') {
		jQuery('button:not(.search_submit):not([class*="sc_button_hover_"]),\
				...
				.clothing69_tabs .clothing69_tabs_titles li a:not([class*="sc_button_hover_"]),\
				...
				').addClass('sc_button_hover_just_init sc_button_hover_'+CLOTHING69_STORAGE['button_hover']);
		if (CLOTHING69_STORAGE['button_hover']!='arrow') {
		...
		jQuery('.sc_price_link:not([class*="sc_button_hover_"])\
				').addClass('sc_button_hover_just_init sc_button_hover_style_extra');
		jQuery('.sidebar .trx_addons_tabs .trx_addons_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
				.clothing69_tabs .clothing69_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
		...
		jQuery('.mejs-controls button,\
				...
				').removeClass('sc_button_hover_'+CLOTHING69_STORAGE['button_hover']);
